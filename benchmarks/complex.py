...
obj = dict(a="a", b=1, c=2.3, d=False, f = dict(g=False,k=[dict(s=i) for i in range(5)]))

class Kserializer(Serializer):
    s=StrField()

class Fserializer(Serializer):
    g = BoolField()
    k=Kserializer(many=True)
...
output_path = './benchmarks/complex.png'
